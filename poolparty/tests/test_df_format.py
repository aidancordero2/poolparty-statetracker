...
class TestGetPoolsReverseTopo:
    ...
    def test_parent_child_order(self):
        ...
        with pp.Party() as party:
            ...
            child = pp.mutagenize_using_num(parent, num_mutations=1)
    ...
    def test_chain_of_pools(self):
        ...
        with pp.Party() as party:
            p1 = pp.from_seqs(['AAA'])
            p2 = pp.mutagenize_using_num(p1, num_mutations=1)
            p3 = pp.mutagenize_using_num(p2, num_mutations=1)
...
class TestIntegrationWithGenerate:
    ...
    def test_generate_with_organize_by_pool(self):
        ...
        with pp.Party() as party:
            ...
            child = pp.mutagenize_using_num(parent, num_mutations=1).named('child')
