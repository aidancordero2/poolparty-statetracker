...
from poolparty.operations.mutagenize_using_num import mutagenize_using_num
...
class TestHybridModeBasic:
    ...
    def test_num_hybrid_states(self):
        ...
        with pp.Party() as party:
            pool = mutagenize_using_num('ACGT', num_mutations=1, mode='hybrid', num_hybrid_states=100)
    ...
    def test_hybrid_mode_requires_num_states(self):
        ...
        with pp.Party() as party:
            with pytest.raises(ValueError, match="num_hybrid_states is required"):
                mutagenize_using_num('ACGT', num_mutations=1, mode='hybrid')
    
    def test_hybrid_mode_generates_correct_count(self):
        """Test that hybrid mode generates the expected number of sequences."""
        with pp.Party() as party:
            pool = mutagenize_using_num('ACGT', num_mutations=1, mode='hybrid', num_hybrid_states=50).named('mutant')
...
class TestHybridModeReproducibility:
    ...
    def test_same_seed_same_results(self):
        ...
        results1 = []
        with pp.Party() as party:
            pool = mutagenize_using_num('ACGTACGT', num_mutations=1, mode='hybrid', num_hybrid_states=10).named('mutant')
    ...
    def test_same_state_same_output(self):
        ...
        with pp.Party() as party:
            pool = mutagenize_using_num('ACGTACGT', num_mutations=1, mode='hybrid', num_hybrid_states=20).named('mutant')
...
class TestHybridModeOperationIsolation:
    ...
    def test_different_ops_different_results(self):
        ...
        with pp.Party() as party:
            # Two mutagenize_using_num operations with same config but different op.id
            pool1 = mutagenize_using_num('ACGTACGT', num_mutations=1, mode='hybrid', num_hybrid_states=10).named('mutant1')
            pool2 = mutagenize_using_num('ACGTACGT', num_mutations=1, mode='hybrid', num_hybrid_states=10).named('mutant2')
...
class TestHybridModeMutationScan:
    """Test hybrid mode specifically for mutagenize_using_num."""
    
    def test_mutagenize_using_num_hybrid_valid_mutations(self):
        """Test that hybrid mutagenize_using_num produces valid mutations."""
        with pp.Party() as party:
            pool = mutagenize_using_num('ACGT', num_mutations=1, mode='hybrid', num_hybrid_states=20).named('mutant')
            df = pool.generate_seqs(num_complete_iterations=1, seed=42)
    ...
    def test_mutagenize_using_num_hybrid_double_mutation(self):
        """Test hybrid mode with num_mutations=2."""
        with pp.Party() as party:
            pool = mutagenize_using_num('ACGTACGT', num_mutations=2, mode='hybrid', num_hybrid_states=30).named('mutant')
            df = pool.generate_seqs(num_complete_iterations=1, seed=42)
...
class TestHybridModeVsRandomMode:
    ...
    def test_hybrid_has_multiple_states(self):
        ...
        with pp.Party() as party:
            random_pool = mutagenize_using_num('ACGT', num_mutations=1, mode='random')
            hybrid_pool = mutagenize_using_num('ACGT', num_mutations=1, mode='hybrid', num_hybrid_states=50)
    ...
    def test_hybrid_iterates_deterministically(self):
        ...
        with pp.Party() as party:
            pool2 = mutagenize_using_num('ACGTACGT', num_mutations=1, mode='hybrid', num_hybrid_states=10).named('mutant')
...
class TestHybridModeComposability:
    ...
    def test_hybrid_with_sequential_parent(self):
        ...
        with pp.Party() as party:
            ...
            mutants = mutagenize_using_num(seqs, num_mutations=1, mode='hybrid', num_hybrid_states=10).named('mutant')
    ...
    def test_hybrid_with_hybrid_parent(self):
        ...
        with pp.Party() as party:
            ...
            mutants = mutagenize_using_num(seqs, num_mutations=1, mode='hybrid', num_hybrid_states=3).named('mutant')
