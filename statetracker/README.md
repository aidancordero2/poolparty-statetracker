...
StateTracker was developed to support the design of complex DNA sequence libraries (see [PoolParty](https://github.com/jbkinney/poolparty-statetracker/edit/main/statetracker/README.md)), but it solves a general problem: **random access to combinatorial spaces**.
