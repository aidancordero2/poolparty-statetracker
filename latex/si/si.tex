...
\subsection{Example 1: Random Mode Operations}
...
\begin{itemize}
    ...
    \item \inpy{generate_seqs(num_complete_iterations=1)} iterates through all 12 states exactly once. More generally, \inpy{num_complete_iterations=N} guarantees that every state is visited exactly $N$ times, with the internal states of the contributing operations cyling in a specific order each time.
